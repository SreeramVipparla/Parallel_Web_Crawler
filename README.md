...
<img src="https://user-images.githubusercontent.com/86887626/144712686-a8d8d478-4504-4f20-ab5b-65a5b2560a89.jpg" width="1000" height="250">

# Introduction

In this project I have created a multi-threaded legacy web crawler using concurrency concepts in Java and HTML. I have also coded the program to take advantage of multi-core architectures to increase crawler throughput(amount of a product or service that a company can produce and deliver to a client within a specified period of time). Furthermore, I have also measured the performance of the crawler to prove that, given the same amount of time, the multi-threaded implementation can visit more web pages than the legacy implementation.
...
The code comes with some JUnit 5 tests to check the work.
